...
For a compact workflow covering marginal effects and hypothesis tests with `PyFixest`, see the dedicated guide on [Marginal Effects & Hypothesis Testing](../how-to/marginaleffects.llms.md).
