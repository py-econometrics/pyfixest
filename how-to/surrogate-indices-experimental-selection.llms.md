# Surrogate Indices & Experimental Selection

Core Estimation

Outline for estimating long-run effects with surrogates and applying experimental selection correction in PyFixest.
