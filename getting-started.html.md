...
<table style="width: 100%; table-layout: fixed; border-collapse: collapse; border: 1px solid #d0d7de;">
  ...
  <tbody>
    ...
    <tr>
      <td style="border: 1px solid #d0d7de; padding: 8px;"><a href="tutorials/instrumental-variables.qmd">Instrumental Variables</a></td>
      <td style="border: 1px solid #d0d7de; padding: 8px;">We illustrate IV estimation with <code>PyFixest</code> using examples from the literature on the motherhood penalty and encouragement designs in tech companies.</td>
    </tr>
    <tr>
      <td style="border: 1px solid #d0d7de; padding: 8px;"><a href="tutorials/poisson-glm.qmd">Poisson &amp; GLMs</a></td>
      <td style="border: 1px solid #d0d7de; padding: 8px;">This vignette explains how to fit generalized linear models with <code>PyFixest</code>, how to compute marginal effects via the <code>marginaleffects</code> integration, and more.</td>
    </tr>
    <tr>
