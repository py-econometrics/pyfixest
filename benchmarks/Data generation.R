...
save(base_all, file = paste0(path,"/base_all_simulations.Rdata"))
...
data.table::fwrite(base, paste0(path, "/base_10M.csv"))
...
save(base_all_diff, file = paste0(path, "base_all_diff.Rdata"))
