...
def test_hc_equivalence(data):
    ...
    tstat = fixest.tstat()
    boot_tstat = fixest.wildboottest(param="X2", B=999, adj = False, cluster_adj = False)["t value"]
    ...
    tstat = fixest.tstat()
    boot_tstat = fixest.wildboottest(param = "X1", B = 999, adj = False, cluster_adj = False)["t value"]
...
def test_crv1_equivalence(data):
    ...
    boot_tstat = fixest.wildboottest(param = "X1", cluster = "f1", B = 999, adj = False, cluster_adj = False)["t value"]
