...
def test_input_formula_to_dict():
    ...
    assert _input_formula_to_dict("a+sw0(x,y)+d") == {"constant": ["a", "d"], "sw0": ["x", "y"]}

    assert _input_formula_to_dict("csw(x,y)") == {"constant": [], "csw": ["x", "y"]}

    assert _input_formula_to_dict("csw0(x,y,z)") == {"constant": [], "csw0": ["x", "y", "z"]}
...
def test_dict_to_list_of_formulas():
    ...
    assert _dict_to_list_of_formulas({"constant": [], "sw0": ["a", "b"]}) == ["0", "a", "b"]
    ...
    assert _dict_to_list_of_formulas({"constant": [], "csw0": ["a", "b"]}) == ["0", "a", "a+b"]
    ...
    assert _dict_to_list_of_formulas({"constant": [], "csw": ["a", "b"]}) == ["a", "a+b"]
