...
def _assert_backend_matches(
    ...
    assert actual.covariance.df_k == reference.covariance.df_k, context
    assert actual.covariance.df_t == reference.covariance.df_t, context
    ...
    np.testing.assert_allclose(
        actual.covariance.vcov,
        reference.covariance.vcov,
        rtol=0,
