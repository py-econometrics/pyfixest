...
def test_fixest_multi_shares_preconditioners_by_na_index():
    ...
    assert first.sample.excluded_positions == second.sample.excluded_positions
    assert extra_na_index not in first.sample.excluded_positions
    assert extra_na_index in third.sample.excluded_positions
    ...
    assert set(first._demean_cache.lookup_preconditioner) == {
        first.sample.excluded_positions,
        third.sample.excluded_positions,
    }
