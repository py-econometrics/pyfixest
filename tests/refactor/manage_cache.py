"""
FEOLS-specific cache manager.

⚠️  DEPRECATED: Use cache_manager.py for unified management of all test methods.
This script is kept for backward compatibility and FEOLS-specific operations.
