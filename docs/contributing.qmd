...
We also have to install a small latex distribution into our dev environment: 

```{.bash .code-copy}
pixi run -e docs docs-tinytex
```
...
Note: quarto is automatically installed in your local dev env.
