---
title: Contributing
description: "Set up a PyFixest development environment, find architectural guidance, and submit tested, documented changes."
toc: true
...
Start with the repository-maintained [PyFixest architecture guide](architecture.qmd)
