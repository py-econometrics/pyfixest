...
description: "Recover from common formula, inference, stored-data, optional-dependency, and reporting errors in PyFixest."
---
...
- Formula parsing and multiple estimation: [Formula syntax](tutorials/formula-syntax.qmd)
- Variance estimators and clustering: [Standard errors and inference](tutorials/standard-errors.qmd)
- Small-sample corrections: [Small sample corrections](explanation/ssc.qmd)
- Fixed-effects convergence: [Choosing a demeaner](how-to/demeaner-backends.qmd)
- Result tables and plots: [Regression tables](tutorials/regression-tables.qmd)
