...
The leading underscore indicates that these model-level attributes are internal attributes rather than part of the stable public method API. See the [Function Reference](reference/index.qmd) for the full set of model methods and attributes.
