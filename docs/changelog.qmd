...
- Randomization inference now reports the binomial Monte Carlo standard error without a confidence multiplier and uses the requested two-sided coverage for its probability interval, bounded to `[0, 1]`.
