...
working weights. The reused factorization is "stale" - it was built for the
first iteration's weights - but LSMR still converges to the correct demeaned
