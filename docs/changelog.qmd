...
- `Feols.dfm_heterogeneity_test()` adds an omnibus test for systematic treatment
  effect heterogeneity (Ding, Feller, Miratrix 2019): it fits separate OLS by
  treatment arm and jointly tests whether the treatment effect varies with the
  model's covariates.
