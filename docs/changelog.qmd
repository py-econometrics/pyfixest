...
We add support for safe anytime-valid inference (SAVI) for linear regression,
following [Lindon et al (2026)](https://arxiv.org/abs/2210.08589).

SAVI e-values, sequential p-values, and confidence sequences are available via
`evalue()`, `sequential_pvalue()`, and `confint(inference_type="savi")`:
