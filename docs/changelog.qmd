...
- Romano–Wolf and Westfall–Young randomization inference now retain the requested number of replications for clustered models instead of incorrectly applying the wild-bootstrap enumeration limit.
