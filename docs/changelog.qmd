...
- The Standard Errors & Inference tutorial now documents IID,
  heteroskedasticity-robust, clustered, HAC, bootstrap, and randomization-based
  inference with executed examples and explicit support limits, and records
  which fits `ritest()` supports. The `fepois` docstring no longer claims
  wild-bootstrap support.
