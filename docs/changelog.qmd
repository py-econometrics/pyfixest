...
Varying-slope fixed-effect syntax is now parsed and materialized internally.
Estimation with varying slopes remains disabled until backend support is available.
