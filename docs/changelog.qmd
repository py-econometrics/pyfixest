...
- `store_data=False` and `lean=True` now apply to every child of a multiple estimation and to IV first stages, release execution caches, and raise `MissingModelDataError` when an operation needs omitted state.
