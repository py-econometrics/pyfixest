...
- Saturated OLS fits now preserve identified coefficients and return `NaN` for undefined adjusted R² and adjusted within R² instead of failing during fit-statistic calculation.
