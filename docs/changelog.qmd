...
- Contributor and coding-agent guidance now routes architecture, numerical
  validation, verification, review, and PR handoff through maintained local
  developer documentation and a compact R-reference edit check.
