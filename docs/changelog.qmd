...
- Randomization inference now accepts string, categorical, and nullable integer cluster labels while retaining explicit errors for missing cluster identifiers.
