---
title: Changelog
description: "Release notes for every PyFixest version, covering new features, behavior changes, deprecations, and bug fixes."
freeze: auto
---
...
- Every documentation page now carries a title, which names it in `llms.txt`,
  and a one-sentence description, which the listing pages and page metadata use.
