...
- The pixi workspace now declares the benchmark feature's CUDA requirement as a
  rich platform instead of the deprecated `[system-requirements]` table, and the
  lockfile moves to format v7. Contributors and CI need pixi 0.71.0 or newer.
