...
- DID estimators now accept signed, unsigned, and nonmissing nullable integer time/cohort columns that fit in `int64`, preserving negative relative periods for unsigned inputs.
