...
One new feature that already made it's way into the code base is a new typed demeaner configuration that performs really well for sparse fixed effects structures.
