---
title: "OLS with Fixed Effects EXAMPLE"
description: "Twin studies and 'AKM' regressions in worker-firm panels: two cases studies in controlling for unobserved heterogeneity with fixed effects."
...
For some background reading on AKM models and their application, take a look at this slide deck: [AKM Lecture Slides](https://eml.berkeley.edu/~cle/e250a_f14/lecture11.pdf). (And yes, charts this pretty are only ok if you won a Nobel Prize.)
...
Another very relevant class of fixed effects models are [Difference-in-Differences vignette](difference-in-differences.qmd) designs and estimators.
:::
