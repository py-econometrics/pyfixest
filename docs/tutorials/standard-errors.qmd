...
For family-wise error control and power-aware corrections, see:

- [How-To: Multiple Hypothesis Testing Corrections](../how-to/multiple_testing.qmd)

This dedicated vignette covers `bonferroni()`, `rwolf()`, and `wyoung()`.
