...
For a quick introduction, you can take a look at the [Getting Started](getting-started.qmd) guide and [Tutorials](tutorials/index.qmd), or the regression chapter of [Coding for Economists](https://aeturrell.github.io/coding-for-economists/econmt-regression.html#imports). You can find documentation of all user facing functions in the [Function Reference](reference/index.qmd) section of the documentation.
