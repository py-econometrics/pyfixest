...
pyfixest = Fixest(data = data).fepois(fml, vcov = {'CRV1':'X4'}, ssc = ssc(adj = False, cluster_adj = False))
...
def absolute_diff(x, y, tol = 1e-04):
...
fit = fepois(fml, data = data, cluster = ~X4, ssc = ssc(adj = FALSE, cluster.adj = FALSE))
