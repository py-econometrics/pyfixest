...
| `pixi run -e py312 test-estimation-snapshots` | Fast balanced public-fit regression feedback against the committed release contract; no R or coverage | Seconds to a few minutes |
