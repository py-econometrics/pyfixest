...
The `use_compression` argument to `feols()` is deprecated and will be removed in
a future release. This feature implemented the in-memory regression compression
approach from [Wong et al. (2021)](https://arxiv.org/abs/2102.11297) via a
Mundlak/sufficient-statistics transform. For large-dataset use cases, the
