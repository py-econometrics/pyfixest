<!-- Generated from docs/getting-started.qmd; do not edit. -->
...
You can browse all tutorials in the [Tutorial Gallery](tutorials/index.md), or see the [How-To Guides](how-to/marginaleffects.md) for task-oriented recipes. The [Function Reference](reference/index.md) has all details around functions and their arguments, classes, methods, and attributes.
