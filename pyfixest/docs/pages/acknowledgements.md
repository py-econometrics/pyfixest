<!-- Generated from docs/acknowledgements.md; do not edit. -->
...
| Package | Language | Role |
|---|---|---|
| **lfe** *(binary asset omitted)* | R | We based our first implementation of the MAP algorithm on the description in the "how lfe works" vignette. |
...
- Gaure, S. (2013). "OLS with multiple high dimensional category variables." *Computational Statistics & Data Analysis*, 66, 8-18. Vignette: How lfe works *(binary asset omitted)*.
