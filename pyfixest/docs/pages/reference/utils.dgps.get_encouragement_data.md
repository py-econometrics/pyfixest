<!-- Generated from docs/reference/utils.dgps.get_encouragement_data.qmd; do not edit. -->

# utils.dgps.get_encouragement_data

```python
utils.dgps.get_encouragement_data(N=4000, seed=1234)
```
