<!-- Generated from docs/reference/estimation.quantreg.quantreg_.Quantreg.qmd; do not edit. -->
...
| [vcov](#pyfixest.estimation.quantreg.quantreg_.Quantreg.vcov) | Update quantile-regression inference with a covariance estimator. |
...
```python
estimation.quantreg.quantreg_.Quantreg.vcov(vcov, vcov_kwargs=None, data=None)
```
