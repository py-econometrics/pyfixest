<!-- Generated from docs/reference/estimation.models.feols_.Feols.qmd; do not edit. -->
...
Construct models with [feols()](estimation.api.feols.feols.md),
...
| collin_tol   | float                      | Tolerance for collinearity checks. Public estimators default to `1e-9`.                                                                                                                                                                                              | _required_          |
...
| Name        | Type                                   | Description                                                                                                                                                                                                                              | Default    |
|-------------|----------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------|
| vcov        | RegressionVcovType or dict\[str, str\] | Covariance estimator. Use iid, hetero, HC1, HC2, HC3, NW, DK, or a CRV1/CRV3 clustering dictionary. CRV3 is not supported for IV models.                                                                                                 | _required_ |
| vcov_kwargs | VcovKwargs                             | HAC configuration. NW and DK require lag and time_id; DK also requires panel_id.                                                                                                                                                         | `None`     |
| data        | DataFrameType                          | Original input data or the estimation sample. Pass it when the model was fitted with store_data=False and inference needs columns for new clustering or HAC. Score-based iid and heteroskedastic inference do not require retained data. | `None`     |

#### Returns

| Name   | Type   | Description                                                                                         |
|--------|--------|-----------------------------------------------------------------------------------------------------|
|        | Feols  | An instance of class [Feols](estimation.models.feols_.Feols.md) with updated inference. |
