<!-- Generated from docs/reference/report.coefplot.qmd; do not edit. -->
...
| plot_backend  | PlotBackend                                                              | The plotting backend to use. Options are "lets_plot" (default if installed) and "matplotlib". If "lets_plot" is specified but not installed, an ImportError will be raised with instructions to install it or use "matplotlib" instead.                                                                                                                                                                                                                                     | `'lets_plot' if _HAS_LETS_PLOT else 'matplotlib'` |
