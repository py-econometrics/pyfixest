<!-- Generated from docs/tutorials/poisson-glm.qmd; do not edit. -->
...
For a compact workflow covering marginal effects and hypothesis tests with `PyFixest`, see the dedicated guide on [Marginal Effects & Hypothesis Testing](../how-to/marginaleffects.md).
...
- [Standard Errors & Inference](standard-errors.md): clustered inference, randomization inference, and wild bootstrap.
