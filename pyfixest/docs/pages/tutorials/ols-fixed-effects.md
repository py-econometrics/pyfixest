<!-- Generated from docs/tutorials/ols-fixed-effects.qmd; do not edit. -->
...
For some background reading on AKM models and their application, take a look at this slide deck: AKM Lecture Slides *(binary asset omitted)*.
...
## Next Step: Difference-in-Differences
Another very relevant class of fixed effects models are used in [Difference-in-Differences designs](difference-in-differences.md).
