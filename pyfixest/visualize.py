...
def iplot(
    ...
    yintercept : int or None, optional
        The value at which to draw a horizontal line on the plot. Default is None.
...
def coefplot(
    ...
    Parameters
    ----------
    models : list or Feols or Fepois
        A list of fitted models of type `Feols` or `Fepois`, or just a single model.
    figsize : tuple
        The size of the figure.
    alpha : float
    ...
    -------
    lets_plot figure
        A lets-plot figure object representing the plotted model coefficients with confidence intervals.
    """
