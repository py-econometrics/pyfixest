# estimation.post_estimation.multcomp.wyoung { #pyfixest.estimation.post_estimation.multcomp.wyoung }
...
|--------|--------------|-----------------------------------------------------------------------------------------------|
|        | pd.DataFrame | A DataFrame containing estimation statistics, including the Westfall-Young adjusted p-values. |
