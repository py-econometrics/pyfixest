...
| Name | Description |
| --- | --- |
| [Fepois](#pyfixest.fepois.Fepois) | Class to estimate Poisson Regressions, inheriting from [Feols(/docs/reference/Feols.qmd). This class overwrites the `get_fit()` method from [Feols(/docs/reference/Feols.qmd) |
