...
|-----------------|-------------------------|-------------------------------------------------------------------------------|--------------|
| `models`        | list or Feols or Fepois | A list of fitted models of type `Feols` or `Fepois`, or just a single model.  | _required_   |
...
| Type             | Description                                                                                      |
|------------------|--------------------------------------------------------------------------------------------------|
| lets_plot figure | A lets-plot figure object representing the plotted model coefficients with confidence intervals. |